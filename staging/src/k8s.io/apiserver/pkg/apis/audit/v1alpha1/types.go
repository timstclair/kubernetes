...
type Event struct {
	...
	// +optional
	RequestBody string `json:"requestBody,omitempty" protobuf:"bytes,12,opt,name=requestBody"`
	// API object returned in the response, in JSON. The ResponseObject is recorded after conversion
	// to the external type, and serialized as JSON.  Omitted for non-resource requests.  Only logged
	// at ResponseObject Level and higher.
	// +optional
	ResponseBody string `json:"responseBody,omitempty" protobuf:"bytes,13,opt,name=responseBody"`
}
